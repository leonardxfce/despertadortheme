...
get_header(); ?>
    ...
    <div id="primary">
        <div id="content" role="main">
            ...
            <article id="post-0" class="post error404 not-found">
                <header class="entry-header">
                    <div id="cats"><h1 class="entry-title"><?php _e('Lo sentimos', 'twentyeleven'); ?></h1></div>
                </header>
        ...
        $archive_content = '<p>' . sprintf(__('Intenta buscar en las notas mensuales. %1$s', 'twentyeleven'), convert_smilies(':)')) . '</p>';
